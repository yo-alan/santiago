...
('RED', 19, 'Expresión y comunicación', 1, 1),
('RED', 20, 'Inglés I', 1, 1),
('RED', 21, 'Matemática aplicada I', 1, 1),
('RED', 22, 'Arquitectura de computadoras I', 1, 1),
('RED', 23, 'Electrónica I', 1, 1),
('RED', 24, 'Física para las telecomunicaciones', 1, 1),
('RED', 25, 'Programación I', 1, 1),
('RED', 26, 'Sistemas operativos I', 1, 2),
('RED', 27, 'Programación II', 1, 2),
('RED', 28, 'Arquitectura de computadoras II', 1, 2),
('RED', 29, 'Física para las telecomunicaciones II', 1, 2),
('RED', 30, 'Legislación de las comunicaciones', 2, 1),
('RED', 31, 'Talleres de tecnología aplicada', 2, 1),
('RED', 32, 'Matemática aplicada II', 2, 1),
('RED', 33, 'Programación III', 2, 1),
('RED', 34, 'Redes', 2, 1),
('RED', 35, 'Electrónica II', 2, 1),
('RED', 36, 'Arquitectura de computadoras III', 2, 1),
('RED', 37, 'Sistemas operativos II', 2, 1),
('RED', 38, 'Gestión y administración empresarial', 2, 2),
('RED', 39, 'Tratamiento de señal', 2, 2),
('RED', 40, 'Equipos y medios de transmisión I', 2, 2),
('RED', 41, 'Actualización tecnológica I', 2, 2),
('RED', 42, 'Transmisión de datos I', 2, 2),
('RED', 43, 'Actualización tecnológica II', 3, 1),
('RED', 44, 'Transmisión de datos II', 3, 1),
('RED', 45, 'Redes de alta velocidad', 3, 1),
('RED', 46, 'Sistemas telefónicos', 3, 1),
('RED', 47, 'Ingeniería de protocolos', 3, 2),
('RED', 48, 'Equipos y medios de transmisión II', 3, 2),
('RED', 49, 'Sistemas operativos III', 3, 2),
('SFW', 50, 'Introducción a la programación', 1, 1),
('SFW', 51, 'Laboratorio de programación', 1, 1),
('SFW', 52, 'Matemática aplicada I', 1, 1),
('SFW', 53, 'Inglés I', 1, 1),
('SFW', 54, 'Técnicas avanzadas de programación', 1, 2),
('SFW', 55, 'Estructura de datos y algoritmos', 1, 2),
('SFW', 56, 'Paradigmans de programación', 1, 2),
('SFW', 57, 'Matématica aplicada II', 1, 2),
('SFW', 58, 'Inglés II', 1, 2),
('SFW', 59, 'Laboratorio Avanzado de Programación II', 2, 1),
('SFW', 60, 'Bases de datos I', 2, 1),
('SFW', 61, 'Programación web I', 2, 1),
('SFW', 62, 'Redes y seguridad informática', 2, 1),
('SFW', 63, 'Ingeniería de software', 2, 2),
('SFW', 64, 'Programación web II', 2, 2),
('SFW', 65, 'Bases de datos II', 2, 2),
('SFW', 66, 'Gestión de proyectos de software', 2, 2);
